  ...
  return (
    <div className=" h-svh grid grid-cols-12 gap-4 p-2 max-h-svh ">
      ...
      <div className="col-span-full md:col-span-6 rounded-[12px] relative flex flex-col justify-center items-center">
        ...
        <div className="absolute bottom-0 w-full text-[12px] flex justify-center gap-x-5 gap-y-2 md:justify-between flex-wrap items-center text-neutral-400 dark:text-300">
